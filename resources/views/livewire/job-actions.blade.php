            ...
            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                {{ 'Failed :'. $created_at }}
                    ...
                    @endif
                        ...
                        <button class="flex text-white bg-green-500 border-0 py-1 px-4 focus:outline-none hover:bg-green-600 rounded-full text-xs mt-2 justify-start">
                            Re-analyze
                        </button>
